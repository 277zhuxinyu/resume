...
<%--<div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
        <li>
            ...
            <a href="/logins?username=${user.username}&password=${user.password}">首页</a>
        </li>
        ...
        <div class="d_Confirm_Order_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <form action="/admin_user/selectBySearch" method="post">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <a href="/admin_user/form" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <c:forEach items="${users}" var="user">
                        <tr>
                            <td><label><input type="checkbox" id="${user.id}" class="minimal"><span
                                    class="lbl"></span></label></td>
                            <td>${user.id}</td>
                            <td><u style="cursor:pointer" class="text-primary" onclick="str(${user.id})">${user.username}</u></td>
                            <td>${user.password}</td>
                            <td>${user.grade}</td>
                            <td class="td-status">
                            ...
                            <td class="td-manage">
                                ...
                                <a onClick="member_start(this,${user.id})" href="javascript:;" title="启用"
                                       class="btn btn-xs"><i class="icon-ok bigger-120"></i></a>

                                <a title="编辑" href="javascript:;" onclick="location.href='/admin_user/form?id=${user.id}'"
                                ...
                                <a title="删除" href="javascript:;" onclick="member_del(${user.id})"
...
<div class="add_menber" id="add_menber_style" style="display:none">
    ...
    <ul class=" page-content">
        ...
        <li><label class="label_name">身&nbsp;&nbsp;份 &nbsp;证：</label><span class="add_name">
            <input name="icard" id="icard" type="text" required="required" class="text_add"/></span>
            <div class="prompt r_f"></div>
        </li>
        <li><label class="label_name">昵&nbsp;&nbsp;称：</label><span class="add_name">
            <input name="nickname" id="nickname" type="text" required="required" class="text_add"/></span>
            <div class="prompt r_f"></div>
        </li>
            ...
            yes: function (index, layero) {
                ...
                if (num > 0) {
                    ...
                    $.ajax({
                        "url": "/admin_user/save",
                        "type": "GET",
                        "data": {"cname": username, "password": password, "type": type,"email":email,"phone":phone,"icard":icard,"nickname":nickname},
                        "success": function (data) {
