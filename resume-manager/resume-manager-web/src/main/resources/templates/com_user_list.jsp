        ...
        <div class="d_Confirm_Order_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <form action="/com_user/selectBySearch" method="post">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <a href="/com_user/form" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <c:forEach items="${users}" var="user">
                        <tr>
                            ...
                            <td>${user.id}</td>
                            <td><u style="cursor:pointer" class="text-primary" onclick="str(${user.id})">${user.cname}</u></td>
                            <td>${user.password}</td>
                            <td>${user.email}</td>
                            <td>${user.phone}</td>
                            <td class="td-status">
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑" href="javascript:;" onclick="location.href='/com_user/form?id=${user.id}'"
