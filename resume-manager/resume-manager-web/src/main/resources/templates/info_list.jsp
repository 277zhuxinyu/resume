        ...
        <div class="d_Confirm_Order_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <form action="${pageContext.request.contextPath }/info/selectBySearch" method="post">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <a href="/info/form" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加资讯</a>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <c:forEach items="${informationList}" var="information">
                        <tr>
                            <td><label><input type="checkbox" id="${information.id}" class="ace"><span
                                    class="lbl"></span></label></td>
                            <td>${information.id}</td>
                            <td><u style="cursor:pointer" class="text-primary"
                                   onclick="showDetail(${information.id})">${information.infoName}</u></td>
                            <td class="text-l">${information.infoContent}</td>
                            <td>${information.infoType}</td>
                            <td>${information.infoCreated}

                            </td>
                            <td class="td-manage">
                                <a title="编辑" href="javascript:;" onclick="location.href='/info/form?id=${information.id}'"
                                   class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>
                                <a title="删除" href="javascript:;" onclick="member_del(${information.id})"
    ...
    jQuery(function ($) {
        var oTable1 = $('#sample-table').dataTable({
            ...
            "aoColumnDefs": [
                ...
                {"orderable": false, "aTargets": [0,4,6]}// 制定列不参与排序
            ]
        });
