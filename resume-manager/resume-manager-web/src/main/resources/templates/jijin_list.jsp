    ...
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <a href="/jijin/form"  class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                    <c:forEach items="${JiJins}" var="jiJin">
                        <tr>
                            <td><label><input type="checkbox" id="${jiJin.id}" class="ace"><span
                            ...
                            <td>${jiJin.apply}</td>
                            <td>${jiJin.buyBack}</td>
                            <td>${jiJin.serviceCharge}</td>
                            <td>${jiJin.unitNetvalue}</td>
                            <td>${jiJin.cumulativeNetvalue}</td>
                            <td>${jiJin.week}</td>
                            <td>${jiJin.onemonth}</td>
                            <td>${jiJin.threemonths}</td>
                            <td>${jiJin.sixmonths}</td>
                            <td>${jiJin.year}</td>
                            <td>${jiJin.threeyear}</td>
                            <td class="td-manage">
                                <a title="编辑" href="javascript:;" onclick="location.href='/jijin/form?id=${jiJin.id}'"
                                   class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>

                                <a title="删除" href="javascript:;" onclick="member_del(${jiJin.id})"
