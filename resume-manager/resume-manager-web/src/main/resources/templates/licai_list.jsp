    ...
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <a href="/licai/form"  class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <c:forEach items="${products}" var="product">
                        <tr>
                            <td><label><input type="checkbox" id="${product.pid}" class="ace"><span
                            ...
                            <td class="td-manage">
                                <a title="编辑" href="javascript:;" onclick="location.href='/licai/form?pid=${product.pid}'"
                                   class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>

                                <a title="删除" href="javascript:;" onclick="member_del(${product.pid})"
