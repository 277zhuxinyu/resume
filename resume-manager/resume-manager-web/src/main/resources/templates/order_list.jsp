        ...
        <div class="d_Confirm_Order_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <form action="/order/selectBySearch" method="post">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <%--<a href="/order/form" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>--%>
            ...
            <div class="table_menu_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <c:forEach items="${orders}" var="order">
                        <tr>
                            <td><label><input type="checkbox" id="${order.id}" class="ace"><span
                                    class="lbl"></span></label></td>
                            <td>${order.id}</td>
                            <td>${order.name}</td>
                            <td class="text-l">${order.time}</td>
                            <td>${order.money}</td>
                            <td>${order.rate}</td>
                            ...
                            <td>${order.uname}</td>
                            <td class="td-manage">
                                <a title="编辑" href="javascript:;" onclick="location.href='/order/form?id=${order.id}'"
                                   class="btn btn-xs btn-info"><i class="icon-edit bigger-120"></i></a>
                                <a title="删除" href="javascript:;" onclick="member_del(${order.id})"
    ...
    jQuery(function ($) {
        var oTable1 = $('#sample-table').dataTable({
            ...
            "aoColumnDefs": [
                ...
                {"orderable": false, "aTargets": [0, 2, 8,9]}// 制定列不参与排序
            ]
        });
