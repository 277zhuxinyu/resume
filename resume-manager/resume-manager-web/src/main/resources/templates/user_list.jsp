...
<%--<div class="breadcrumbs" id="breadcrumbs">
    <ul class="breadcrumb">
        &lt;%&ndash;<li>
            ...
            &lt;%&ndash;<a href="/logins?username=${user.username}&password=${user.password}">首页</a>&ndash;%&gt;
        </li>&ndash;%&gt;
    ...
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            ...
            <div class="border clearfix">
                   ...
                   <span class="l_f">
                    <a href="/user/form" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加用户</a>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <c:forEach items="${users}" var="user">
                        <tr>
                            ...
                            <td>${user.id}</td>
                            <td><u style="cursor:pointer" class="text-primary" onclick="str(${user.id})">${user.pname}</u></td>
                            <td>${user.password}</td>
                            <td>${user.email}</td>
                            <td>${user.phone}</td>
                            <td class="td-status">
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑" href="javascript:;" onclick="location.href='/user/form?id=${user.id}'"
            ...
            yes: function (index, layero) {
                ...
                if (num > 0) {
                    ...
                    $.ajax({
                        "url": "/user/save",
                        "type": "GET",
                        "data": {"pname": username, "password": password, "type": type,"email":email,"phone":phone,"icard":icard,"nickname":nickname},
                        "success": function (data) {
